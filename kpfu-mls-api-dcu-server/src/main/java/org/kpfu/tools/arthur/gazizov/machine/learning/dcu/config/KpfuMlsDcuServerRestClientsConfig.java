...
import org.kpfu.tools.arthur.gazizov.machine.learning.engine.inference.rest.client.EngineInferenceClientImpl;
...
public class KpfuMlsDcuServerRestClientsConfig {
  ...
  @Bean
  public EngineInferenceClient engineInferenceClient() {
    return EngineInferenceClientImpl.Builder.aFsClientImpl()
            .serverUrl(properties.getMlsEngineInferenceServerUrl())
            .build();
  }
}
